...
<div class="absolute flex flex-row justify-center items-center w-screen mt-10">
    ...
    <a href="/calendar"
        class="absolute flex flex-row align-center justify-center gap-1 py-2 border-2 group transition-all w-26 flex flex-nowrap text-black hover:no-underline duration-300 rounded-full px-2 py-1 border-2 border-purple-500 hover:bg-purple-500 hover:text-black">Calendar<svg
