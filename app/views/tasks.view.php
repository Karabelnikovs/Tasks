...
<?php if (isset($_SESSION["user_id"])) { ?>
    <a href="logout"
        class="group transition-all w-24 flex flex-nowrap text-white hover:no-underline duration-300 rounded-full px-2 py-1 absolute top-7 left-10 border-2 border-red-500 hover:bg-red-500">Log
