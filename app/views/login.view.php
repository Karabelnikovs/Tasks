...
<div class="relative   min-h-screen  sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
    <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
        <div class="self-start hidden lg:flex flex-col  text-gray-300">
            ...
            <p class="pr-3 text-sm opacity-75">Here you can write down your tasks!</p>
        </div>
    </div>
        ...
        <div class="p-12 bg-white mx-auto rounded-3xl w-96 shadow-xl">
            <div class="mb-7">
                ...
                <p class="text-gray-400 font-bold">Don't have an account? <a href="signup"
                        class="text-sm text-purple-700 hover:text-purple-700 font-extrabold">Sign Up</a></p><br>
                ...
                <svg class="absolute bottom-0 left-0 -z-40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
