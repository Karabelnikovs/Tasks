...
<!-- <p><a href="login" class="btn btn-outline-danger">Atpakaļ</a></p> -->
    ...
    <form method="post" id="signup" novalidate>
            <div class="space-y-6">
				<div class="">
					<input type="email" id="email" name="email" value="<?= $_POST['email'] ?? "" ?>" class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" placeholder="Email">
              </div>

    
        <div class="space-y-6">
            <input type="text" id="name" name="username" value="<?= $_POST['username'] ?? "" ?>" class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" placeholder="Username">
        </div>

        <div class="relative" x-data="{ show: true }">
            <input id="password" name="password" value="<?= $_POST['password'] ?? "" ?>"
                 placeholder="Password" :type="show ? 'password' : 'text'" class="text-sm text-gray-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
        ...
        <div class="relative" x-data="{ show: true }">
            <input id="password_confirmation" name="password_confirmation" value="<?= $_POST['password_confirmation'] ?? "" ?>"
                 placeholder="Password" :type="show ? 'password' : 'text'" class="text-sm text-gray-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
        <div class="flex items-center absolute inset-y-0 right-0 mr-3  text-sm leading-5">
