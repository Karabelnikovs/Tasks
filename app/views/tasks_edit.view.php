    ...
    <div
        ...
        <form class="w-100 h-100 flex flex-col items-center justify-center gap-3" method="post" action="create">
            ...
            <textarea name="description" placeholder="Description"
                class="resize-none bg-gray-700 rounded-xl w-65 h-50 text-gray-400 p-1 px-2 outline outline-purple-400 outline-2 focus:outline-offset-2"><?= $tasks[0]["DESCRIPTION"] ?></textarea>
