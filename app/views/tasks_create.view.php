...
<?php } else { ?>
    <a href="login"
        class="group transition-all w-24 flex flex-nowrap text-white hover:no-underline duration-300 rounded-full px-2 py-1 absolute top-7 left-10 border-2 border-green-500 hover:bg-green-500">Log
        in
    ...
    <div
        ...
        <form class="w-100 h-100 flex flex-col items-center justify-center gap-3" method="post" action="create">
            <input name="title" type="text" placeholder="Title"
                value="<?= isset($_POST["title"]) ? $_POST["title"] : "" ?>" class="bg-gray-700 rounded-lg text-gray">
            ...
            <input name="deadline_date" type="datetime-local"
                ...
                class="bg-gray-700 rounded-lg text-gray">
